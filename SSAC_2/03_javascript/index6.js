...
console.log(fruits.charAt(8));
console.log(fruits.charAt(10)); // ''

console.log(fruits.slice(5)); // mango
console.log(fruits.slice(3, 6)); // lem
console.log(fruits.slice(-1)); // o
console.log(fruits.slice(-4)); // ango
...
for (let area in areaNum) {
  ...
  console.log(areaNum[area]); // 값에 접근할 때는 대괄호 접근법으로만 사용 가능
}
